...
Set lnk = objShell.CreateShortcut(deskt & "\MC Modinstaller 4.3.LNK")
...
Set lnk2 = objShell.CreateShortcut(appDataLocation & "\Microsoft\Windows\Start Menu\Programs\MC Modinstaller 4.3.LNK")
